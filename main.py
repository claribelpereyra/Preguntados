    ...
    if categoria == 'HISTORIA':
        ...
        if eleccion_dificultad == "BÁSICO":
            ...
            if nro_preg == 0:
                ...
                pregunta = ["¿Qué investigadora argentina en el campo de la biotecnología fue pionera en el desarrollo de bioproductos y es cofundadora de la empresa Bioceres?
                            "Silvia Gold", "Gabriela Aguirre", "Andrea Gamarnik", "Norma Sánchez", 1]
        else:
            if nro_preg == 0:
                pregunta = ["¿Qué físico argentino fue co-descubridor de los agujeros negros de masa intermedia y es conocido por su trabajo en el LIGO (Observatorio de Ondas Gravitacionales por Interferometría Láser)?
